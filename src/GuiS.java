...
public class GuiS {
	...
	public GuiS(){
		...
		JTextArea infotext = new JTextArea("Alkoholische Getränke: "+Main.liste[Gui.selUser].statsAlk+" für insgesamt "+Main.liste[Gui.selUser].statsAlk * 1.5 +" € \n"
											+ "Antialkoholische Getränke: "+Main.liste[Gui.selUser].statsAnt+" für insgesamt "+Main.liste[Gui.selUser].statsAnt * 1.0 +" €", 2, 3);
